...
/* Strands (React Bits) — flowing WebGL light strands. Ported to TypeScript. */
...
export default function Strands({
  ...
  // Keep latest props in the ref without mutating during render.
  useEffect(() => {
    propsRef.current = {
      colors,
      count,
  ...
  return (
    <div ref={ctnDom} className={`relative w-full h-full bg-transparent ${className}`} style={style} />
  );
}
