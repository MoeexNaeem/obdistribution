...
/* ScrollStack (React Bits) — pinned cards that scale/stack on scroll. TS port. */
...
export const ScrollStackItem = ({
  ...
  <div
    className={`scroll-stack-card relative w-full my-8 p-8 sm:p-12 rounded-[12px] border border-hairline bg-paper box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[12vh] pb-[8rem] min-h-full">
        {children}
